...
class crash_binning:
    ...
    def record_crash(self, pydbg, extra=None):
        ...
        except_addr = pydbg.dbg.u.Exception.ExceptionRecord.ExceptionAddress
        exception_module = pydbg.addr_to_module(except_addr)
        ...
        if crash.exception_address not in self.bins.keys():
