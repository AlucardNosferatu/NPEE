...
from modules.opencv import cv_cut_img, cv_ocr_img, cv_show_img, cv_init_cap, cv_is_cap_opened, cv_read_cap, cv_close_cap
...
m_dict = {
    ...
    'CV_CUT_IMG': cv_cut_img, 'CV_OCR_IMG': cv_ocr_img, 'CV_SHOW_IMG': cv_show_img, 'CV_INIT_CAP': cv_init_cap, 'CV_IS_CAP_OPENED': cv_is_cap_opened, 'CV_READ_CAP': cv_read_cap, 'CV_CLOSE_CAP': cv_close_cap,
